...
<body style="background-color: skyblue;">
    <div class="container mt-5">
        ...
        <a href="show.php" class="btn btn-primary mb-3" style="background-color: lawngreen;">Lihat Data Produk</a>
        <form action="./backend/create.php" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success" name="submit" style="background-color: blueviolet;">Simpan</button>
        </form>
    </div>
</body>
</html>
